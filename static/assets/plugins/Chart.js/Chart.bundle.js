...
function isObjectEmpty(obj) {
    var k;
    for (k in obj) {
        // event if its not own property I'd still call it non-empty
        return false;
    }
    return true;
}
	...
	helpers.extend(Chart.Controller.prototype, /** @lends Chart.Controller.prototype */ {
		...
		*/
		...
		handleEvent: function(e) {
			...
			// Remove styling for last active (event if it may still be active)
...
module.exports = function(Chart) {
	...
	Chart.scaleService = {
		...
		constructors: {},
		// Use a registration function so that we can move to an js map when we no longer need to support
		// old browsers
